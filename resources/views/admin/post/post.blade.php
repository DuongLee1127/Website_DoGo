                        ...
                        <tr class="tr-active">
                            ...
                            <td>
                                <label class="switch switch-3d switch-success mr-3">
                                    <input type="checkbox" data-modalId="{{ $post->id }}" data-publish="status" value="{{ $post->status }}" class="switch-input status" {{ ($post->status == '1')?'checked':'' }}/>
                            ...
                            <td>
                                <div class="table-data-feature center-icon">
                                    <a class="item" data-toggle="tooltip" data-placement="top"
                                        href="{{ route('admin.post.edit', $post->id) }}" data-original-title="Edit">
                                    ...
                                    <button type="button" class="item btn-delete" data-id="{{ $post->id }}">
                                        <i class="zmdi zmdi-delete"></i>
                                    </button>
                                    <!--
                                                                                    </form> -->
                                    <!-- <a class="item" data-toggle="tooltip" data-placement="top" href="{{ route('admin.post.delete', $post->id) }}
