    ...
    protected function gd_create_scaled_image($file_name, $version, $options) {
        ...
        switch ($type) {
            ...
            case 'webp':
                ...
                $image_quality = isset($options['webp_quality']) ? $options['webp_quality'] : 80;
                break;
            case 'avif':
                $src_func = 'imagecreatefromavif';
                $write_func = 'imageavif';
                $image_quality = isset($options['avif_quality']) ? $options['avif_quality'] : 80;
                break;
            default:
                return false;
        }
        ...
        if (!$src_img) {
            error_log('saveImage: Could not create image resource from file: ' . $file_path);
            return false;
        }
        ...
        if (!$src_img || !$new_img) {
            error_log("saveImage error: Invalid image resource.");
            return false;
        }
