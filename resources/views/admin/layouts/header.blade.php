                            ...
                            <div class="header-button">
                                <div class="noti-wrap">
                                    ...
                                    <div class="noti__item js-item-menu">
                                        ...
                                        <div class="email-dropdown js-dropdown">
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="{{ asset('admin_assets/images/icon/avatar-04.jpg') }}" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                                    <p>Meeting about new dashboard...</p>
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="{{ asset('admin_assets/images/icon/admin.jpg') }}" alt="John Doe" />
                                        </div>
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">{{  isset(auth()->user()->name)?auth()->user()->name:'Người dùng ẩn danh' }}</a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="#">{{ isset(auth()->user()->name)?auth()->user()->name:'Người dùng ẩn danh' }}</a>
                                                    </h5>
                                                    <span class="email">{{ isset(auth()->user()->name)?auth()->user()->email:'unknow' }}</span>
                                                </div>
                                            </div>
