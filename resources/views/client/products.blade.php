   <!-- Modal Search Start -->
        ...
        <div class="container-fluid fruite py-5">
            <div class="container py-5">
                <h1 class="mb-4 customize-text customize-shadow">Gỗ Gỗ</h1>
                <div class="row g-4">
                    <div class="col-lg-12">
                        <div class="row g-4">
                            <div class="col-xl-3">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <ul class="list-unstyled fruite-categorie">
                                                ...
                                                <li>
                                                    <div class="d-flex justify-content-between fruite-name">
                                                        <a href="#"><i class="fas fa-apple-alt me-2"></i>Lục bình</a>
                                                        <span>(5)</span>
                                                    </div>
                                                </li>
                                            </ul>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="d-flex align-items-center justify-content-start">
                                            <div class="rounded me-4" style="width: 100px; height: 100px;">
                                                <img src="{{ asset('users_assets/img/15.jpg') }}" class="img-fluid feature-img rounded" alt="">
                                            </div>
                                            <div>
                                                ...
                                                <div class="d-flex mb-2">
                                                    <h5 class="fw-bold me-2">10.000 VNĐ</h5>
                                                    <h5 class="text-danger text-decoration-line-through">11.000 VNĐ</h5>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-start">
                                            <div class="rounded me-4" style="width: 100px; height: 100px;">
                                                <img src="{{ asset('users_assets/img/23.jpg') }}" class="img-fluid feature-img rounded" alt="">
                                            </div>
                                            <div>
                                                <h6 class="mb-2">Gỗ Gỗ</h6>
                                                <div class="d-flex mb-2">
                                        ...
                                        <div class="d-flex align-items-center justify-content-start">
                                            <div class="rounded me-4" style="width: 100px; height: 100px;">
                                                <img src="{{ asset('users_assets/img/12.jpg') }}" class="img-fluid feature-img rounded" alt="">
                                            </div>
                                            <div>
                                                <h6 class="mb-2">Gỗ Gỗ</h6>
                                                <div class="d-flex mb-2">
                                        ...
                                        <div class="col-md-6 col-lg-6 col-xl-4">
                                            <div class="rounded position-relative fruite-item">
                                                <div class="fruite-img">
                                                    <img src="{{ $product->images()->first()->image_path }}" class="img-fluid w500 rounded-top" alt="">
                                                </div>
