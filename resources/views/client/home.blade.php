            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-12 col-lg-7">
                        <h4 class="mb-3 customize-text-second customize-shadow">abc aklsd aksd ak sdj fls asa aad</h4>
                        <h1 class="mb-5 display-3 customize-text customize-shadow">Ack akd l;a akk akdfe akdkf akjf</h1>
